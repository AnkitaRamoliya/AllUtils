...
public class DateUtils {
    ...
    public static Date convertDateStringToDate(String strDate, String currentFormat, String parseFormat) {
        try {
            return convertStringToDate(convertDateStringToString(strDate, currentFormat, parseFormat), parseFormat);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
